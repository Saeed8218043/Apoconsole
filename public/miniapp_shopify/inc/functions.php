<?php
define('NGROK_URL', "https://app.apoconsole.com"); // Replace with your DOMAIN URL
define('SHOPIFY_API_KEY', "c79ae2004cf9110ba4a751fb5e4226cd"); // Replace with your API KEY
define('SHOPIFY_SECRUT_KEY', "2daf864f9d937103a81f8f77a01a0507"); // Replace with your SECRET KEY
define('Domain_URL_', "https://app.apoconsole.com/miniapp_shopify");
...
// 	$modified_product_inventory_quantity_response = $modified_product_inventory_quantity['response'];
	return $modified_product_inventory_quantity;
	return $modified_product_inventory_quantity['response'];
}
...
function Adject_Price__Function($access_token, $host_shop, $varsion, $variant_ID, $adjustment_Price)
{
	...
	$modify_data = array(
		"variant" => array(
			"id" => $variant_ID,
        	"price" => round($adjustment_Price , 2)
...
// 	$modified_product_response = $modified_product;
// 	print_r($modify_data);
