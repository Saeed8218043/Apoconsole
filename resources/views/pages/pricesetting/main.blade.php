        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-user-table-filter="search"
                        class="form-control form-control-solid w-250px ps-14" placeholder="Search Price Setting" />
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
            ...
            <div class="card-toolbar ">
                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    ...
                    <!-- theme()->getView('pages/pricesetting/modal') -->

                    {{ theme()->getView('pages/pricesetting/edit_niches') }}
                    <!--begin::Filter-->
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_coupons">
                ...
                <thead>
                    ...
                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-50px">Vendor</th>
                        <th class="min-w-50px">Max Qty</th>
                        <th class="min-w-50px">Fee</th>
                        <th class="min-w-50px">Commission</th>
                         <th class="min-w-50px">Shipping</th>
                         <th class="min-w-50px">Price Percentage</th>
...
<script>
            ...
            var KTUsersList = (function() {
                ...
                var initUserTable = function() {
                    ...
                    datatable = $(table).DataTable({
                        ajax: {
                            url: "<?= route('pricesetting.datatableapi') ?>",
                            data: {
                                // ;
 ...
 function edit(id){
               ...
               console.log("aly");
               console.log(data);
                             $('#kt_modal_edit_price_update').find('input[name=vendor_id]').val(id);

              $('#kt_modal_edit_price_update').find('input[name=vendor]').val(data['vendor_id']);

               $('#kt_modal_edit_price_update').find('input[name=max_qty]').val(parseInt(data['quantity']));
               $('#kt_modal_edit_price_update').find('input[name=fee]').val(parseInt(data['fee']));
               $('#kt_modal_edit_price_update').find('input[name=commission]').val(parseInt(data['commission']));
                $('#kt_modal_edit_price_update').find('input[name=shipping]').val(parseInt(data['shipping']));
                $('#kt_modal_edit_price_update').find('input[name=price_percentage]').val(parseInt(data['price_percentage']));
               $('#kt_modal_edit_price_update').find('input[name=profit]').val(parseInt(data['profit']));

               url = $('#kt_modal_edit_price_update').attr('dt-action');
               $('#kt_modal_edit_price_update').attr('action',url+'/'+id);
...
function tp_update(){
  ...
  if (commission != ''){
      tp+=parseInt(commission);
  }
  if (shipping != ''){
      tp+=parseInt(shipping);
  }
  if (profit != ''){
      tp+=parseInt(profit);
  }
...
$(document).ready(function(){
        ...
        $('#kt_price_setting_form').on('submit', function(event){
