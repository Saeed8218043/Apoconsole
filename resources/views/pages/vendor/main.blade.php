            ...
            <div class="card-toolbar ">
                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <div class="px-7 py-5" data-kt-user-table-filter="form">
                            ...
                            <div class="mb-10">
                                ...
                                <select id="vendor_f"   class="form-select form-select-solid fw-bolder" data-kt-select2="true"
                                    ...
                                    <option></option>
                                    <option value="1" >TRQ</option>
                                    <option value="2" >LKQ</option>
                    ...
                    <!--end::Filter-->
                     ...
                     {{ theme()->getView('pages/vendor/add_vendor',['users'=>$users]) }}
                      {{ theme()->getView('pages/vendor/edit_vendor') }}
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_coupons">
                ...
                <thead>
                    ...
                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px" style="padding-left: 25px !important;">ACTION</th>
            ...
            var KTUsersList = (function() {
                ...
                var initUserTable = function() {
                    ...
                    datatable = $(table).DataTable({
                        ajax: {
                            url: "<?= route('vendorlist.datatableapi') ?>",
                            data: {
                                found: 1,
                                // ;
                                ...
                                if (result.value) {
                                    Swal.fire({
                                        ...
                                        .then(function() {
                                            ...
                                            $.ajax({
                                                url: "<?= route('vendorlist.bulkdelete') ?>",
                                                type: 'POST',
                                                data: {
                                                    "list": id,
                                                    "_token": token,
