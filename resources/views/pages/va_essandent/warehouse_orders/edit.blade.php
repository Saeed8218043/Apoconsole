                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body scroll-y mx-3 mx-xl-5 my-3">
                                    <!--begin::Form-->
                                    <form id="kt_modal_edit_coupon_form" dt-action="{{ route('va.order.edit') }}" enctype="multipart/form-data"
                                        ...
                                        <div class="d-flex flex-column scroll-y"
                                            ...
                                            <div class="fv-row mb-7">
                                                <label class=" fw-bold fs-6 mb-2">Labels</label>
                                                <input  type="file" name="labels" class="form-control form-control-solid mb-3 mb-lg-0" accept="application/pdf" />
                                            </div>
