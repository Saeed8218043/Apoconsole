                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body scroll-y mx-3 mx-xl-5 my-3">
                                    <!--begin::Form-->
                                    <form id="kt_modal_add_coupon_form" action="{{ route('va.order.store') }}" enctype="multipart/form-data"
                                        ...
                                        <div class="d-flex flex-column scroll-y"
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <input required type="date" name="ship_by_date" id="ship_by_date" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Select date" >
                                            </div>
                                            ...
                                            <div class="fv-row mb-7">
                                                <label class="required fw-bold fs-6 mb-2">Label Quantity</label>
                                                <input required type="number" name="ordered_items" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Enter Quantity" step="1" pattern="\d+"  />
                                            </div>


                                            <div class="fv-row mb-7">
                                                <label class="required fw-bold fs-6 mb-2">Labels</label>
                                                <input required type="file" name="labels" class="form-control form-control-solid mb-3 mb-lg-0" accept="application/pdf" />
                                            </div>
