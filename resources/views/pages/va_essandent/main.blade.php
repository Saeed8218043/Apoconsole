        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar gap-1">
                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    ...
                    {{ theme()->getView('pages/va_essandent/edit',['users'=>$users,'warehouse' =>$warehouse]) }}
                    {{ theme()->getView('pages/va_essandent/return',['users'=>$users,'warehouse' =>$warehouse]) }}
                    {{ theme()->getView('pages/va_essandent/reOrder',['users'=>$users,'warehouse' =>$warehouse]) }}
        ...
        var KTUsersList = (function() {
            ...
            var initUserTable = function() {
                ...
                datatable = $(table).DataTable({
                    ajax: {
                        url: "<?= route('va_warehouse.datatableapi') ?>"
                        , data: {
                            found: 1,
