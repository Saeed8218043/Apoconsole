...
<div class="modal fade" id="reOrder" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-3 mx-xl-5 my-3">
                <!--begin::Form-->
                <form id="reOrder_form" action="{{ route('va.reOrder') }}" enctype="multipart/form-data"
                    ...
                    <input type="hidden" name="warehouse_name" class="warehouse_name">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input required type="text" name="order_id" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Enter Price"  />
                        </div>
                    ...
                    <div class="text-center pt-15">
                        ...
                        <button type="submit" class="btn btn-primary" id="reOrder_submit"
