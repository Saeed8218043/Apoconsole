                     ...
                     <div class="modal fade" id="trqrma" tabindex="-1" aria-hidden="true">
                        <!--begin::Modal dialog-->
                                          ...
                                          <div class="mb-3">
                                           ...
                                           <div class="mb-3">
                                            ...
                                            <select  type="text" name="reason"  class="form-control form-select" >
                                                <option value="501" >Arrived Too Late</option>
                                                <option value="503" >Ordered Incorrectly</option>


                                                </select>
                                          </div>

                                          <input type="hidden" name="operation" value="rma">

                                            <div class="mb-3 text-center p-5">
                                                <button type="button" class="btn btn-primary" onclick="submitrma($(this).closest('form')[0])" >Submit</button>
                                          </div>
