                     ...
                     <div class="modal fade" id="trqcancel" tabindex="-1" aria-hidden="true">
                        <!--begin::Modal dialog-->
                        <div class="modal-dialog modal-dialog-centered mw-750px">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header" id="kt_modal_add_credits_header">
                                    <!--begin::Modal title-->
                                    <h2 class="fw-bolder" id="order_detail_header" >Cancel Order</h2>
                                    <!--end::Modal title-->
                                    <!--begin::Close-->
                                    <div class="btn btn-icon btn-sm btn-active-icon-primary close" data-bs-toggle="modal"
                                        data-bs-target="#trqcancel">
  ...
  <tbody class="trqcancelitem_table" >
...
<hr></hr>
                                          ...
                                          <div class="mb-3">
                                            ...
                                            <select  type="text" name="reason"  class="form-control form-select" >
                                                <option value="20" >The item is Out of Stock (OOS) and cannot be filled at this time</option>
                                                <option value="501" >The order or item is no longer needed.</option>
                     ...
                     <button type="button" class="btn btn-primary" onclick="submitcancel($(this).closest('form')[0])" >Cancel Now</button>
                                          </div>
