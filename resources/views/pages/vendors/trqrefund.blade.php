                     ...
                     <div class="modal fade" id="trqrefund" tabindex="-1" aria-hidden="true">
                        <!--begin::Modal dialog-->
  ...
  <tbody class="trqrefunditem_table" >
...
<hr></hr>
                                          ...
                                          <div class="mb-3">
                                           ...
                                           <div class="mb-3">
                                            ...
                                            <select  type="text" name="reason"  class="form-control form-select" >
                                                <option value="60" >Warranty Defect</option>
                                                <option value="90" >Damaged in Transit</option>
                                                <option value="92" >Missing Package no delivery</option>
                                                <option value="103" >Incorrect Quantity or Product Received</option>
                     ...
                     <button type="button" class="btn btn-primary" onclick="submitrefund($(this).closest('form')[0])" >Submit</button>
                                          </div>
