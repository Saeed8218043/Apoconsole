            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_coupons">
                ...
                <thead>
                    ...
                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-50px">Part Numebr</th>
                        <th class="min-w-50px">Order Time</th>
                        <th class="min-w-50px">Tracking No</th>
                        <th class="min-w-50px">Tracking Time</th>
...
<script>
            ...
            var KTUsersList = (function() {
                ...
                var initUserTable = function() {
                    ...
                    datatable = $(table).DataTable({
                        ajax: {
                            url: "<?= route('tracking.datatableapi') ?>",
                            data: {
                                // ;
 ...
 function edit(id){
               ...
               console.log("aly");
               console.log(data);
              $('#kt_modal_edit_price_update').find('select[name=vendor]').val(data['vendor_id']);
