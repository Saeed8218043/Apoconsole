    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-3 mx-xl-5 my-3">
                <!--begin::Form-->
                <form id="kt_modal_edit_coupon_form" dt-action="{{ route('inventory.edit') }}" enctype="multipart/form-data"
                    ...
                    <div class="d-flex flex-column scroll-y"
                        ...
                        <input type="hidden" name="warehouse_name" id="warehouse_name3">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input required type="date" name="expected_delivery" id="expected_delivery2" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Select date" >
                        </div>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input required type="text" name="inventory_count" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Enter inventory count" min="1" step="1" pattern="\d+"/>
                        </div>
