                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                   ...
                   <!--begin::Filter-->
                    ...
                    <!--end::Filter-->
                     ...
                     {{ theme()->getView('pages/warehouse_new_inventory/add',['users'=>$users,'warehouse' =>$warehouse]) }}
                      {{ theme()->getView('pages/warehouse_new_inventory/edit',['users'=>$users,'warehouse' =>$warehouse]) }}



                         {{ theme()->getView('pages/warehouse_new_inventory/approve',['users'=>$users,'warehouse' =>$warehouse]) }}
            ...
            var KTUsersList = (function() {
                ...
                var initUserTable = function() {
                    ...
                    datatable = $(table).DataTable({
                        ajax: {
                            url: "<?= route('inventory.datatableapi') ?>",
                            data: {
                                found: 1,
                                name: "{{$warehouse_name}}",
...
$(document).ready(function() {
    ...
    $('#warehouse_name2').val(warehouse_name);
    $('#warehouse_name3').val(warehouse_name);
...
$(function() {
            ...
            $('#expected_delivery1, #expected_delivery2').datepicker({
                dateFormat: 'dd-M-yy', // Correct format for jQuery UI Datepicker
                autoclose: true,
                firstDay: 1
            });
