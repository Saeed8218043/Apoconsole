                   ...
                   <button type="button" class="btn btn-primary me-3" data-bs-toggle="modal" data-bs-target="#check_stock">
                     ...
                     <div class="modal fade" id="check_stock" tabindex="-1" aria-hidden="true">
                        <!--begin::Modal dialog-->
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body scroll-y mx-3 mx-xl-5 my-3">
                                    <!--begin::Form-->
                                    <form id="check_stock_form" action="{{ route('pf.store') }}" enctype="multipart/form-data"
                                        ...
                                        <div class="d-flex flex-column scroll-y"
                                            ...
                                            <div class="fv-row mb-7">
                                                <!--begin::Label-->
                                                <label class="required fw-bold fs-6 mb-2">Enter Sku</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                        ...
                                        <div class="text-center pt-15">
                                            <button type="reset" class="btn btn-light me-3" data-bs-toggle="modal"
                                                data-bs-target="#check_stock">Discard</button>
