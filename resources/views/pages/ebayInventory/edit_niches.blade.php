                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header" id="kt_modal_add_credits_header">
                                    <!--begin::Modal title-->
                                    <h2 class="fw-bolder">Edit Niches</h2>
                                    <!--end::Modal title-->
                                    <!--begin::Close-->
                                ...
                                <div class="modal-body scroll-y mx-3 mx-xl-5 my-3">
                                    <!--begin::Form-->
                                    <form id="kt_modal_edit_coupon_form" dt-action="{{ route('pf.store') }}" enctype="multipart/form-data"
                    ...
                    <label class=" col-form-label fw-bold fs-6">
                        ...
                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="{{ __('Select Vendor on which PF you want to apply setting') }}"></i>
                    </label>
                    <!--end::Label-->

                    <!--begin::Col-->
                    <div class=" fv-row">
                        <select name="vendor"  aria-label="{{ __('Select a Vendor') }}" class="form-select form-select-solid form-select-lg fw-bold">
                    ...
                    <!--end::Col-->
                                              ...
                                              <div class="fv-row mb-7">
                                               ...
                                               <div class="form-check form-switch">
                                                   <label class="form-check-label" for="flexSwitchCheckDefault">Accept Price Master Rule</label>
                                                    <input class="form-check-input" type="checkbox" name="pricemasterrule">
                                            ...
                                            <div class="fv-row mb-7">
                                                <!--begin::Label-->
                                                <label class="required fw-bold fs-6 mb-2">Cost</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                            ...
                                            <div class="fv-row mb-7">
                                                <!--begin::Label-->
                                                <label class="required fw-bold fs-6 mb-2">Fee</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                            ...
                                            <div class="fv-row mb-7">
                                                <!--begin::Label-->
                                                <label class="required fw-bold fs-6 mb-2">Commission</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
