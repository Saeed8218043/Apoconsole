    ...
    <div class="p-6">
        <div class="row gx-2">
            ...
            <div class="col-2">
                ...
                <a type="button" href="{{ route('exportCsvToday') }}" class="btn btn-primary btn-sm mb-3" >Today sheet</a>
                <a type="button" href="{{ route('exportCsvMonth') }}" class="btn btn-primary btn-sm mb-3" >Monthly sheet</a>
            </div>
        </div>
    </div>
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar ">
                ...
                <a type="button" href="{{ route('exportCsvFiltered') }}" id="exportCsvButton" class="btn btn-primary me-3" >Tracking
                </a>
                <!--begin::Toolbar-->
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base" data-kt-user-table-filter="form">
                       <select name="status" class="form-control form-control-solid" style="font-size: 12px; width: auto; margin-right: .75rem !important; background-color: #0000001a;">
                        <option>All</option>
                        <option>Open</option>
                    ...
                    <input type="date" name="start_date" class="form-control form-control-solid " style="font-size: 12px; width: auto; margin-right: .75rem !important; background-color: #0000001a;">

                    <input type="date" name="end_date" class="form-control form-control-solid" style="font-size: 12px; width: auto; margin-right: .75rem !important; background-color: #0000001a;">

                    <button type="reset" class="btn btn-light btn-active-light-primary fw-bold me-2 px-6 me-3" data-kt-menu-dismiss="true" data-kt-user-table-filter="reset" style="font-size: 12px; width: auto;">Reset</button>

                    <button type="submit" class="btn btn-primary fw-bold px-6 me-3" data-kt-menu-dismiss="true" style="font-size: 12px; width: auto; margin-right: .75rem !important;" data-kt-user-table-filter="filter">Apply</button>
                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <a type="button" href="{{ route('exportToCsv', ['store' => $storeName]) }}" class="btn btn-primary me-3" >{{ $file_name }}
                   </a>
...
function add_item(sku){
    ...
    $('.error-message').text(errorMessage);
            ...
            success:function(data)
            {
               ...
               if (data.items[0].trackingNumbers[0] != undefined){
                 track = '<a target="_blank" href="https://wwwapps.ups.com/WebTracking/track?track=yes&trackNums='+data.items[0].trackingNumbers[0].trackingNumber+'" >'+data.items[0]['trackingNumbers'][0].trackingNumber+'</a>';
               }
            }


               shippingdetial = '<strong>Shipping Method: </strong>'+data.shippingMethod+'<br><strong>Tracking Number: </strong>'+track+'<br>';
...
function hideLoader(modal) {
  ...
  $.ajax({
        ...
        function submitrma(form) {
            ...
            axios.post('{{ route("trqrma") }}', new FormData(form))
                .then(function(response) {
                    ...
                    if (response.data.id != undefined) {
                        Swal.fire({
                            text: "RMA Submitted Successfully"
                            , icon: "success"
                            , buttonsStyling: false
                            , confirmButtonText: "Ok, got it!"
                            , customClass: {
  ...
  $.ajax({
        ...
        function submitrefund(form) {
            ...
            axios.post('{{ route("trqrefund") }}', new FormData(form))
                .then(function(response) {
                    response = response;
                    console.log(response);
                    if (response.data.message != undefined) {
