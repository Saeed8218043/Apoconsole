...
<div class="card ">
    ...
    <div class="p-6 pb-0">
        <div class="row gx-2">
            ...
            <div class="col-xl-3 col-lg-4">
                <!--begin::Card title-->
                <div class="card-title pt-3 pt-lg-6 d-flex justify-content-start justify-content-lg-end">
                    <!--begin::Search-->
        ...
        <div class="card-header border-0 pt-0">
            ...
            <div class="card-toolbar w-100">
                ...
                @php
                    $storeName = request()->segment(2);
                @endphp
                <div class="d-flex flex-wrap gap-1 mb-2" data-kt-user-table-toolbar="base">
                    <a type="button" href="{{ route('exportToCsv', ['store' => $storeName]) }}" class="btn btn-primary" >{{ $file_name }}
                   </a>
 ...
 <script src="/demo6/plugins/custom/datatables/datatables.bundle.js"></script>
        ...
        $(document).ready(function() {
            ...
            // Access the second segment (index 1) and set it as the value of the element with ID 'echStore'
            $('#echStore').val(pathSegments[2]);
            $('#echStore2').val(pathSegments[2]);
    ...
    $('.error-message').text(errorMessage);
            ...
            success:function(data)
            {
               ...
               shipto = data.shippingName+'<br>'+data.shippingAddress1+'<br>'+data.shippingAddress2+'<br>'+data.shippingCity+' ,'+data.shippingRegion+' ,'+data.shippingPostalCode+' ,'+data.shippingRegion+'<br> '+data.shippingCountry;
                ...
                var formattedDate = orderDate.toLocaleDateString('en-US', options).replace(/\//g, '-');
...
$(document).ready(function(){
        ...
        // Set the values in the select elements based on the column names
        $('#csv_table').on('shown.bs.modal', function () {
        var url = window.location.href;
        var urlSegments = url.split('/');
        if (urlSegments.includes('Flex')) {

            $('select[name="poNumber"]').val('0');
            $('select[name="shippingName"]').val('17');
            $('select[name="shippingAddress1"]').val('18');
            $('select[name="shippingAddress2"]').val('19');
            $('select[name="shippingPostalCode"]').val('23');
            $('select[name="shippingCountry"]').val('24');
            $('select[name="shippingCity"]').val('21');
            $('select[name="shippingRegion"]').val('22');
            $('select[name="sku"]').val('8');
            $('select[name="sales_price"]').val('12');
            $('select[name="quantity"]').val('10');
            $('select[name="order_date"]').val('2');

            $('select[name="poNumber"],select[name="shippingName"],select[name="shippingAddress1"],select[name="shippingAddress2"],select[name="shippingPostalCode"],select[name="shippingCity"]').change(function(){

            $('select[name="poNumber"]').val($('select[name="poNumber"] option:selected').text());
            $('select[name="shippingAddress1"]').val($('select[name="shippingAddress1"] option:selected').text());
            $('select[name="shippingAddress2"]').val($('select[name="shippingAddress2"] option:selected').text());
            $('select[name="shippingPostalCode"]').val($('select[name="shippingPostalCode"] option:selected').text());
            $('select[name="shippingCity"]').val($('select[name="shippingCity"] option:selected').text());
            $('select[name="shippingCountry"]').val($('select[name="shippingCountry"] option:selected').text());
            $('select[name="shippingRegion"]').val($('select[name="shippingRegion"] option:selected').text());
            $('select[name="sku"]').val($('select[name="sku"] option:selected').text());
            $('select[name="sales_price"]').val($('select[name="sales_price"] option:selected').text());
            $('select[name="quantity"]').val($('select[name="quantity"] option:selected').text());
            $('select[name="order_date"]').val($('select[name="order_date"] option:selected').text());
        });
    }
});
    ...
    // else{
            // $('select[name="poNumber"]').val('1');
            // $('select[name="shippingName"]').val('14');
            // $('select[name="shippingAddress1"]').val('16');
            // $('select[name="shippingAddress2"]').val('17');
            // $('select[name="shippingPostalCode"]').val('20');
            // $('select[name="shippingCountry"]').val('31');
            // $('select[name="shippingCity"]').val('18');
            // $('select[name="shippingRegion"]').val('19');
            // $('select[name="sku"]').val('24');
            // $('select[name="sales_price"]').val('27');
            // $('select[name="quantity"]').val('26');
            // $('select[name="order_date"]').val('49');
        // }
        ...
        var store = "{{$store}}";
    $("#kt_header_nav > div > h1").text(store);
