<button type="button" class="btn btn-sm btn-primary me-1" data-bs-toggle="modal" data-bs-target="#single_data">
...
<div class="modal fade" id="single_data" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" id="kt_modal_add_credits_header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">Add item data</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body scroll-y mx-3 mx-xl-5 my-3">
                <!--begin::Form-->
                <form id="kt_modal_single_data_form" action="{{ route('pf.store') }}" enctype="multipart/form-data"
                    class="form" method="post">
                    <!--begin::Scroll-->
                    @csrf
                    <div class="d-flex flex-column" id="kt_modal_add_credits_scroll" data-kt-scroll="true"
                        data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto"
                        data-kt-scroll-dependencies="#kt_modal_add_credits_header"
                        data-kt-scroll-wrappers="#kt_modal_add_credits_scroll" data-kt-scroll-offset="300px">

                        <div class="fv-row mb-7" id="single-item-container">

                            <input type="hidden" name="file_name" value="single">
                            <input type="hidden" name="warehouse_name" class="warehouse_name">


                            <div class="row mt-3">
                                <div class="col-6">
                                    <label class="fw-bold fs-6 mb-2">Item Number</label>
                                </div>
                                <div class="col-6">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-6">
                                    <input type="text" name="sku[1]"
                                        class="required form-control form-control-solid " placeholder="Enter SKU"
                                        required>
                                </div>
                            </div>
                        </div>
                        <div class="text-center">
                            <button type="button" class="btn btn-success me-3" id="add-input-sku">Add New SKU</button>
                        </div>
                        ...
                        <div class="text-center pt-15">
                            <button type="reset" class="btn btn-light me-3" data-bs-toggle="modal"
                                data-bs-target="#single_data_button">Discard</button>
...
<button type="button" class="btn btn-sm btn-primary me-1" data-bs-toggle="modal" data-bs-target="#csv_file">
    <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
    <span class="svg-icon svg-icon-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <rect opacity="0.5" x="11.364" y="20.364" width="16" height="2" rx="1"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-3 mx-xl-5 my-3">
                ...
                <form id="kt_modal_add_csv_form" action="{{ route('pf.store') }}" enctype="multipart/form-data"
                    ...
                    <!--begin::Scroll-->
                    @csrf
                    <div class="d-flex flex-column scroll-y" id="kt_modal_add_credits_scroll" data-kt-scroll="true"
                        data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto"
                        data-kt-scroll-dependencies="#kt_modal_add_credits_header"
                        data-kt-scroll-wrappers="#kt_modal_add_credits_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input required type="file" name="file"
                                class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Type..." />
                        </div>
...
<div class="modal fade" id="csv_table" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-3 mx-xl-5 my-3">
                <!--begin::Form-->
                <form id="csv_table_form" action="{{ route('pf.store') }}" enctype="multipart/form-data"
                    class="form" method="post">
                    <!--begin::Scroll-->
                    @csrf
                    <div class="d-flex flex-column scroll-y" id="kt_modal_add_credits_scroll" data-kt-scroll="true"
