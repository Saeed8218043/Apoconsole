                ...
                <form id="kt_modal_add_csv_form" action="{{ route('pf.store') }}" enctype="multipart/form-data"
                  ...
                  function pastexls(e) {
                                    console.log(e);
                                        ...
                                        function add_row() {
                                            $('.calculator_table tbody').prepend(`<tr><td><input type="text" value="" onpaste="pastexls(event)" onchange="calculate_pf()" class="form-control" placeholder="Type Sku..." style="padding: 2px;max-width: 112px;"></td><td></td><td></td><td></td><td></td><td></td><td><button type="button" class="btn btn-danger btn-sm" onclick="removeRow(this)">Remove</button></td></tr>`);
                                        }
