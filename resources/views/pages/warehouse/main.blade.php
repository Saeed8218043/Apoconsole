                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                   ...
                   <!--begin::Filter-->
                    ...
                    <!--end::Filter-->
                     ...
                     {{ theme()->getView('pages/warehouse/add',['users'=>$users,'warehouse' =>$warehouse]) }}
        ...
        <script id="usertable">
            $(document).ready(function() {
                ...
                $('#download_report').on('click', function() {
                    ...
                    link.href = "<?= url('/warehouse-report/' . $warehouse->id) ?>";
                    link.click();
            });
        ...
        $.ajax({
            ...
            function edit(id){
              ...
              var asset_path ="{{ asset('public/warehousedataimage') }}";
               ...
               if (data['inlabel']  != ''){
                   $('#kt_modal_edit_coupon_form').find('#inlabel').html('<a target="_blank" class="btn btn-primary mb-2"  download="'+data['inlabel']+'" href="'+asset_path+'/'+data['inlabel']+'" >'+data['inlabel']+'</a><button onclick="del_label_api(this,'+id+')" type="button" aria-label="Remove Label" title="Remove Label" style="border: none;background: transparent;position: absolute;"><svg aria-hidden="true" focusable="false" class="UppyIcon" width="18" height="18" viewBox="0 0 18 18"><path d="M9 0C4.034 0 0 4.034 0 9s4.034 9 9 9 9-4.034 9-9-4.034-9-9-9z"></path><path fill="#FFF" d="M13 12.222l-.778.778L9 9.778 5.778 13 5 12.222 8.222 9 5 5.778 5.778 5 9 8.222 12.222 5l.778.778L9.778 9z"></path></svg></button>');
            ...
            function ship(id){
              ...
              $('#ship_form').find('#outlabel').html('');
                ...
                if (data['inlabel']  != null && data['inlabel']  != ''){
                   $('#ship_form').find('#outlabel').html('<a target="_blank" class="btn btn-primary mb-2 mt-2"  download="'+data['inlabel']+'" href="'+asset_path+'/'+data['inlabel']+'" >'+data['inlabel']+'</a>');
