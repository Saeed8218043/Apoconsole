                      ...
                      <div class="modal fade" id="csv_table" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body scroll-y mx-3 mx-xl-5 my-3">
                                    <!--begin::Form-->
                                    <form id="csv_table_form" action="{{ route('pf_warehouse.insert-csv') }}" enctype="multipart/form-data"
                                        class="form" method="post">
                                        <!--begin::Scroll-->
                                        @csrf
                                        <div class="d-flex flex-column scroll-y"
                                            ...
                                            <div class="row mt-3" >
                                                <div class="col-6" >
                                                    <label class="fw-bold fs-6 mb-2">Order ID</label>
                                                </div>
                                                <div class="col-6" >
                                                    <select name="order_id" class=" csv_fields form-control form-control-solid " >
                                            ...
                                            <div class="row mt-3" >
                                                <div class="col-6" >
                                                    <label class="fw-bold fs-6 mb-2">Ship by date</label>
                                                </div>
                                                <div class="col-6" >
                                                    <select name="date" class=" csv_fields form-control form-control-solid " >
                                            ...
                                            <div class="row mt-3" >
                                                ...
                                                <div class="col-6" >
                                                    <select name="label_price" class=" csv_fields form-control form-control-solid " >
                                            ...
                                            <div class="row mt-3" >
                                                ...
                                                <div class="col-6" >
                                                    <select name="tracking" class=" csv_fields form-control form-control-solid " >
                                            ...
                                            <div class="row mt-3" >
                                                <div class="col-6" >
                                                    <label class="fw-bold fs-6 mb-2">Quantity to ship</label>
                                                </div>
                                                <div class="col-6" >
