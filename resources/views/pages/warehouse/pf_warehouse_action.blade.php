    ...
    <div  onclick="ship('{{ $row->id }}')" class="menu-item px-3" data-bs-toggle="modal" data-bs-target="#ship" >
      <a href="#" class="menu-link px-3" >Ship</a>
  </div>
    @endif

    <div  onclick="return_item('{{ $row->id }}')" class="menu-item px-3" data-bs-toggle="modal" data-bs-target="#return" >
        <a href="#" class="menu-link px-3" >Return</a>
    </div>
