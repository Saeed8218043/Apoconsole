                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body scroll-y mx-3 mx-xl-5 my-3">
                                    <!--begin::Form-->
                                    <form id="kt_modal_add_coupon_form" action="{{ route('{warehouse}.store',['warehouse'=>$warehouse]) }}" enctype="multipart/form-data"
                                        ...
                                        <div class="d-flex flex-column scroll-y"
                                            ...
                                            {{-- <div class="fv-row mb-7">
                                                <label class="required fw-bold fs-6 mb-2">Market Place In</label>
                                            ...
                                            <div class="fv-row mb-7">
                                                <label class="required fw-bold fs-6 mb-2">Order ID In</label>
                                            ...
                                            {{-- <div class="fv-row mb-7">
                                                <label class="required fw-bold fs-6 mb-2">Part</label>
