        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5 text-center" id="kt_table_coupons">
            ...
            <thead>
                ...
                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-125px text-center ">Purchase Price</th>
                    <th class="min-w-125px text-center ">Reason</th>
        ...
        var KTUsersList = (function() {
            ...
            var initUserTable = function() {
                ...
                datatable = $(table).DataTable({
                    ajax: {
                        url: "<?= route('returns.datatableapi') ?>"
                        , data: {
                            found: 1,
                            name: "{{$warehouse_name}}",
    ...
    if (1) {
        ...
        $(document).ready(function() {
            ...
            $('#download_report').on('click', function() {
                    ...
                    link.href = "{{ route('download.returns.report', ['warehouse' => $warehouse_name]) }}";
