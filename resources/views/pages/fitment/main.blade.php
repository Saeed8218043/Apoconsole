        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar ">
                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    ...
                    {{ theme()->getView('pages/order/add_niches',['users'=>$users]) }}
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_coupons">
                ...
                <thead>
                    ...
                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-50px">From</th>
                        <th class="min-w-50px">To</th>
                        <th class="min-w-50px">Model</th>
                        <th class="min-w-50px">Make</th>
            ...
            var KTUsersList = (function() {
                ...
                var initUserTable = function() {
                    ...
                    datatable = $(table).DataTable({
                        ajax: {
                            url: "<?= route('fitment.datatableapi') ?>",
                            data: {
                                // ;
