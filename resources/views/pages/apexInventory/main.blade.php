...
<div class="card ">
        ...
        <div class="card-header border-0 p-6">
            ...
            <div class="card-toolbar m-0">
                ...
                <div class="d-flex justify-content-start justify-content-sm-end flex-wrap gap-1 button-area tables-buttons align-items-start" style="display: none !important;" data-kt-user-table-toolbar="base">
                    ...
                    <a type="button" id="KitexportButton" href="{{ route('apex.export_inventory') }}" class="btn btn-sm btn-info me-2">
                       Kit Export
                    </a>

                    <a type="button" id="PartexportButton" href="{{ route('apex.parts_export') }}" class="btn btn-sm btn-info me-2">
                        Parts Export
                    </a>

                    {{ theme()->getView('pages/apexInventory/add_csv',['users'=>$users]) }}

                     <!--theme()->getView('pages/pf/add_niches',['users'=>$users]) -->

                    {{ theme()->getView('pages/apexInventory/edit_pf') }}
                    {{-- {{ theme()->getView('pages/pf/edit_niches') }} --}}

                    {{ theme()->getView('pages/apexInventory/pf_vendor_csv') }}

                    {{ theme()->getView('pages/apexInventory/calculator') }}
        ...
        <div class="card-body pt-0 table-responsive">
            ...
            <div class="row">
                <input type="hidden" value="apex" name="warehouse_name">
                <!-- Input Groups Start -->
                <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
                    <label for="walmart-percentage-input">Walmart Percentage</label>
                    <div class="input-group">
                        <input type="number" min="0" max="100" id="walmart-percentage-input" value="{{$walmart_percentage}}" name="walmart_percentage" class="form-control" placeholder="Walmart percentage" aria-label="Walmart percentage" aria-describedby="walmart-percentage">
...
$(document).ready(function(){
    ...
    const $exportButton = $('#KitexportButton');
                ...
                $statusSelect.on('change', function() {
                    ...
                    const baseUrl1 = '{{ route('apex.export_inventory') }}';
                    const url1 = new URL(baseUrl1, window.location.origin);

                    const baseUrl2 = '{{ route('apex.parts_export') }}';
