                      ...
                      <div class="modal fade" id="csv_table" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header" id="kt_modal_add_credits_header">
                                    <!--begin::Modal title-->
                                    <h2 class="fw-bolder">Add Hybrid inventory</h2>
                                    <!--end::Modal title-->
                                    <!--begin::Close-->
                                    <div class="btn btn-icon btn-sm btn-active-icon-primary close" data-bs-toggle="modal"
                                ...
                                <div class="modal-body scroll-y mx-3 mx-xl-5 my-3">
                                    ...
                                    <form id="csv_table_form" action="{{ route('pf.store') }}" enctype="multipart/form-data"
                                        ...
                                        <div class="d-flex flex-column scroll-y"
                                            ...
                                            <div class="row mt-3" >
                                                <div class="col-6" >
                                                    <label class="fw-bold fs-6 mb-2">Walmart Link</label>
                                                </div>
                                                <div class="col-6" >
                                                    <select name="link" class=" csv_fields form-control form-control-solid " >
