...
{{-- edit modal start --}}
        <div class="modal fade kt_modal_edit_affiliation" id="kt_modal_edit_affiliation" tabindex="-1"
        aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder">Edit Affiliation</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                    <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-toggle="modal"
                        data-bs-target="#kt_modal_edit_affiliation">
                ...
                <div class="modal-body scroll-y mx-3 mx-xl-5 my-3">
                    <!--begin::Form-->
                    <form id="kt_modal_update_affiliation_form" class="form edit-form" method="post">
                        @method('put')
                        @csrf
                        <!--begin::Input group-->
                        <div class="fv-row mb-7">
                            ...
                            <label class="fs-6 fw-bold form-label mb-2">
                                ...
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover"
                                    ...
                                    data-bs-content="Company Name is Required."></i>
                            </label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input required class="form-control form-control-solid" placeholder="Enter company Name"
                                name="name" id="name" />
                            <!--end::Input-->
                        </div>
                        <div class="fv-row mb-7">
                            ...
                            <label class="fs-6 fw-bold form-label mb-2">
                                ...
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover"
                                    data-bs-trigger="hover" data-bs-html="true"
                                    data-bs-content="Company Email is Required."></i>
                            </label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input required class="form-control form-control-solid" placeholder="Enter company Email"
                                name="email" />
                            <!--end::Input-->
                        </div>
                        <div class="fv-row mb-7">
                            ...
                            <label class="fs-6 fw-bold form-label mb-2">
                                ...
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover"
                                    data-bs-trigger="hover" data-bs-html="true"
                                    data-bs-content="Company Phone is Required."></i>
                            </label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input required class="form-control form-control-solid" placeholder="Enter Phone"
                                name="phone" />
                            <!--end::Input-->
                        </div>
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input required class="form-control form-control-solid" placeholder="Enter Address"
                                name="address" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                ...
                <label class="form-check form-check-custom form-check-solid me-9">
                    ...
                    <span class="form-check-label" for="kt_permissions_core">Set as core permission</span>
                        ...
                        <div class="text-center pt-15">
                            ...
                            <button type="submit" class="btn btn-primary" id="kt_modal_update_affiliation_form_button"
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    ...
                    <!--end::Filter-->
                    <!--begin::Export-->
                    <button type="button" class="btn btn-light-primary me-3 d-none " data-bs-toggle="modal"
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header" id="kt_modal_add_user_header">
                                    <!--begin::Modal title-->
                                    <h2 class="fw-bolder">Add Affliation</h2>
                                    <!--end::Modal title-->
                                    <!--begin::Close-->
                                    <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_add_user">
                                ...
                                <div class="modal-body  mx-5 mx-xl-15 my-7">
                                    <!--begin::Form-->
                                    <form id="kt_modal_add_user_form" action="/user-management/affiliation/list" enctype="multipart/form-data"
                                        ...
                                        <div class="d-flex flex-column scroll-y"
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <input required type="text" name="phone"
                                                    class="form-control form-control-solid mb-3 mb-lg-0"
                                                    placeholder="+92 0000000000" value="" />
                                                <!--end::Input-->
                                            </div>
                                            <div class="fv-row mb-7">
                                                <!--begin::Label-->
                                                ...
                                                <input required type="text" name="address"
                                                    class="form-control form-control-solid mb-3 mb-lg-0"
                                                    placeholder="House#15 Street#02 Faisalabad" value="" />
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                        </div>
            ...
            var KTUsersList = (function() {
                ...
                var initUserTable = function() {
                    ...
                    datatable = $(table).DataTable({
                        ajax: {
                            url: "<?= route('user-management.affiliation.list.datatableapi') ?>",
                            data: {
                                // ; 
                                ...
                                if (result.value) {
                                    Swal.fire({
                                        ...
                                        .then(function() {
                                            ...
                                            $.ajax({
                                                url: "<?= route('user-management.affiliation.list.bulkdelete') ?>",
                                                type: 'POST',
                                                data: {
