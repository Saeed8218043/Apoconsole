                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-3 mx-xl-5 my-3">
                            <!--begin::Form-->
                            <form id="kt_modal_add_permission_form" action="{{ route('user-management.permissions.store') }}" class="form" method="post">
                                @csrf
                                <!--begin::Input group-->
                                ...
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="fs-6 fw-bold form-label mb-2">
                                        <span class="required">Permission Friendly Name</span>
                                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover"
                                            data-bs-trigger="hover" data-bs-html="true"
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control-solid" placeholder="Enter a permission friendly name"
                                        name="friendly_name" />
                                    <!--end::Input-->
                                </div>
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control-solid" placeholder="Enter a route name"
                                        name="name" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                        ...
                        <label class="form-check form-check-custom form-check-solid me-9">
                            ...
                            <span class="form-check-label" for="kt_permissions_core">Set as core permission</span>
                                ...
                                <div class="text-center pt-15">
                                    ...
                                    id="kt_modal_add_permission_form_button" 
                        ...
                        <label class="form-check form-check-custom form-check-solid me-9">
                            ...
                            <span class="form-check-label" for="kt_permissions_core">Set as core permission</span>
                                ...
                                <div class="text-center pt-15">
                                    ...
                                    <button type="button" class="btn btn-primary"
                                    id="kt_modal_update_permission_form_button"
                                        data-kt-permissions-modal-action="submit">
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_permissions">
                ...
                <thead>
                    ...
                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px">Function Name</th>
                        <th class="min-w-125px">Route Name</th>
