                ...
                <tbody class="text-gray-600 fw-bold">
                    ...
                    @foreach ($data as $row)
                        ...
                        <tr>
                            ...
                            <!--begin::Last login=-->
                            <td>
                                <div class="badge badge-light fw-bolder">{{ $row['last_login'] }}</div>
                            </td>
                            <!--end::Last login=-->
                            <!--begin::Two step=-->
                            <td>{{ $row['two_step'] }}</td>
                            ...
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="<?= route('user-management.user.list.show', ['list' => $row['id']]) ?>"
                                            class="menu-link px-3">Edit</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <form method="POST" id="form<?= $row['id'] ?>"
                                        action="<?= route('user-management.user.list.destroy', ['list' => $row['id']]) ?>"
                                        accept-charset="UTF-8" style="display:inline">
                                        @method('delete')
                                        @csrf
                                    </form>
                                    <div class="menu-item px-3">
                                        <a href="javascript:document.getElementById('form{{ $row['id'] }}').submit()"
