...
<!--begin::Container-->
						<div class="container-xxl" id="kt_content_container">
							...
							<div class="">
								<!--begin::Sidebar-->
								<div class="flex-column flex-lg-row-auto  mb-10 col-lg-6 mx-auto">
									<!--begin::Card-->
										...
										<div class="card-body">
											...
											<div class="d-flex flex-center flex-column py-5">
												...
												<div class="symbol symbol-100px symbol-circle mb-7">
                                                    ...
                                                    <img src="{{ isset($user['image']) && !empty($user['image']) ? asset('/assets/avatar/'.$user['image']) : $default_image }}" alt="image" />
                                                </div>
												<!--end::Avatar-->
												<!--begin::Name-->
											...
											<div id="kt_user_view_details" class="collapse show">
												<div class="pb-5 fs-6">
                                                    ...
                                                    <div class="d-flex my-3 align-items-center gap-4">
                                                        <div class="fw-bolder">Last Name</div>
                                                        <div class="text-gray-600">{{ $user->name }}</div>
                                                    </div>
                                                    ...
                                                    <div class="d-flex my-3 align-items-center gap-4">
                                                        <div class="fw-bolder">Last Login</div>
							...
							<div class="modal fade" id="kt_modal_update_details" tabindex="-1" aria-hidden="true">
								...
								<div class="modal-dialog modal-dialog-centered mw-650px">
									...
									<div class="modal-content">
										<!--begin::Form-->
										<form class="form" method="post"  enctype="multipart/form-data" action="{{ route('user-management.user.list.update',['list'=>$user->id]) }}"  id="kt_modal_update_user_form">
											<!--begin::Modal header-->
											@csrf
											@method('put')
												...
												<div class="d-flex flex-column scroll-y" id="kt_modal_update_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_user_header" data-kt-scroll-wrappers="#kt_modal_update_user_scroll" data-kt-scroll-offset="300px">
													...
													<div id="kt_modal_update_user_user_info" class="collapse show">
														...
														<div class="mb-7">
															...
															<div class="mt-1">
																...
																<div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url(assets/media/avatars/blank.png)">
                                                                    @php
                                                                    $user_image_url = isset($user['image']) && !empty($user['image']) ? asset( '/assets/avatar/'.$user['image']) : $default_image;
                                                                    @endphp
																	<!--begin::Preview existing avatar-->
																	<div class="image-input-wrapper w-125px h-125px" style="background-image: url('{{ $user_image_url }}');"></div>
														...
														<div class="fv-row mb-7">
															...
															<label class="fs-6 fw-bold mb-2">
																<span>Password</span>
																<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Enter New if want to change"></i>
															</label>
															<!--end::Label-->
															<!--begin::Input-->
