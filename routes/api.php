...
Route::get('/testApi', [AmazonController::class, 'TestApi']);
Route::middleware('cors')->group(function () {
    Route::post('/product', [ShopifyController::class, 'product']);
    Route::post('/collectionproduct', [ShopifyController::class, 'collectionproduct']);
});
